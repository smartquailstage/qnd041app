...
class Coupon(models.Model):
    ...
    user = models.ForeignKey(
        ...
        related_name='paas_coupons',
        null=True,
        blank=True,
        
    )

    credito = models.CharField(choices=CREDIT_CHOICES, null=True, blank=True,max_length=150)
    percent_credit = models.IntegerField(null=True,
        blank=True,
        validators=[
            MinValueValidator(0),
