...
from iaas_shop.models import Product
from decimal import Decimal
from django.core.validators import MinValueValidator, \
                                   MaxValueValidator
from iaas_coupons.models import Coupon
...
class IaaSOrderItem(models.Model):
    order = models.ForeignKey(IaaSOrder,
                              related_name='items',
                              on_delete=models.CASCADE)
