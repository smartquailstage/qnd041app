...
def task_instagram_post(self, payload):
    ...
    try:
        ...
        response = send_to_n8n("instagram_post", {
            ...
            "logo_primary": obj.categories.image_1.file.url if obj.categories and obj.categories.logo_1 else None,
            "logo_secondary": obj.categories.image_2.file.url if obj.categories and obj.categories.logo_2 else None,
