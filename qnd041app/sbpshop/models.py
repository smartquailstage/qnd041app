...
class SBPStaffItem(models.Model):
...
class SBPTechnologiesItem(models.Model):
    PLATAFORM_CHOICE = (
...
class SBPProductManual(models.Model):
...
class ManualItem(models.Model):
    manuales = models.ForeignKey(SBPProductManual,
                              related_name='items',
                              on_delete=models.CASCADE)
