...
from citas_regulares.models import EventMember, Event
from citas_regulares.utils import Calendar
from citas_regulares.forms import EventForm, AddMemberForm
...
def create_event(request):
    ...
    if request.POST and form.is_valid():
        ...
        return HttpResponseRedirect(reverse("citas_regulares:calendar"))
    ...
    if request.method == "POST":
        ...
        if forms.is_valid():
            ...
            if member.count() <= 9:
                ...
                return redirect("citas_regulares:calendar")
            else:
