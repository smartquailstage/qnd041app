# Generated by Django 4.2.23 on 2026-01-22 00:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ruc', models.CharField(blank=True, max_length=15, null=True, verbose_name='R.U.C/C.I')),
                ('razon_social', models.CharField(blank=True, max_length=200, null=True, verbose_name='Razón Social')),
                ('sector', models.CharField(blank=True, choices=[('G', 'Gastronómico'), ('T', 'Turismo'), ('Th', 'Tecnología'), ('I', 'Industrial'), ('AG', 'Agricola'), ('I', 'Coorporativo'), ('E', 'Educativo'), ('A', 'Administrativo'), ('A', 'Finaciero'), ('M', 'Medico & Salud'), ('C', 'Contructivo'), ('Co', 'Comercial'), ('L', 'Legal'), ('ET', 'Entretenimiento'), ('M', 'Marketing & Publicitario'), ('GO', 'Gubernamental'), ('ONG', 'Organicion sin fines de lucro'), ('O', 'Otro')], max_length=100, null=True, verbose_name='Sector de Negocios')),
                ('telefono', phonenumber_field.modelfields.PhoneNumberField(default='+593', max_length=128, region=None, validators=[django.core.validators.RegexValidator(message='El número de teléfono debe estar en formato internacional. Ejemplo: +593XXXXXXXXX.', regex='^\\+?593?\\d{9,15}$')], verbose_name='Teléfono convencional de contacto')),
                ...
                ('contract_hash_ip', models.CharField(blank=True, max_length=64, null=True, unique=True)),
                ('contract_hash_dev', models.CharField(blank=True, max_length=64, null=True, unique=True)),
                ('contract_hash_cloud', models.CharField(blank=True, max_length=64, null=True, unique=True)),
                ('signed_contract_ip', models.FileField(blank=True, null=True, upload_to='contracts/signed/')),
                ('contract_signed_at_ip', models.DateTimeField(blank=True, null=True)),
                ('contract_verified_ip', models.BooleanField(default=False)),
                ('signed_contract_dev', models.FileField(blank=True, null=True, upload_to='contracts/signed/')),
                ('contract_signed_at_dev', models.DateTimeField(blank=True, null=True)),
                ('contract_verified_dev', models.BooleanField(default=False)),
                ('signed_contract_cloud', models.FileField(blank=True, null=True, upload_to='contracts/signed/')),
                ('contract_signed_at_cloud', models.DateTimeField(blank=True, null=True)),
                ...
                ('coupon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='paas_orders', to='paas_coupons.coupon')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='paas_orders', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='paas_orders.paasorder')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='paas_order_items', to='paas_shop.product')),
            ],
            options={
