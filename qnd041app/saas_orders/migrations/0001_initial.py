    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='saas_orders', to='saas_coupons.coupon')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='saas_orders.saasorder')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='saas_order_items', to='saas_shop.product')),
            ],
            options={
                'verbose_name': 'Software As Service Order',
                'verbose_name_plural': 'SaaS Orders',
