    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefono', models.CharField(max_length=9, validators=[django.core.validators.RegexValidator(message='Ingrese solo los 9 dígitos del número de teléfono, sin el prefijo +593.', regex='^\\d{9}$')])),
