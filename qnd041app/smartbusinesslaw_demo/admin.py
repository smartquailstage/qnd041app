...
@register_component
class BalanceGeneralComponentDemo(BaseComponent):
...
@register_component
class EstadoResultadosComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class FlujoEfectivoComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class DatosGeneralesComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class CambiosPatrimonioComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class AnexosSCVSComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
    name = "Anexos SCVS"
...
def SCVS_DatosGenerales(obj):
    url_txt = reverse('smartbusinesslaw_demo:txt_datos_generales', args=[obj.id])
   # url_pdf = reverse('smartbusinesslaw_demo:pdf_datos_generales', args=[obj.id])
    return mark_safe(
...
def SCVS_BalanceGeneral(obj):
    url_txt = reverse('smartbusinesslaw_demo:txt_balance_general', args=[obj.id])
  #  url_pdf = reverse('smartbusinesslaw_demo:pdf_balance_general', args=[obj.id])
    return mark_safe(
        f'<a href="{url_txt}" target="_blank"><span class="material-symbols-outlined">download</span> TXT</a> | '
    #    f'<a href="{url_pdf}" target="_blank"><span class="material-symbols-outlined">picture_as_pdf</span> PDF</a>'
    )
...
def SCVS_EstadoResultados(obj):
    url_txt = reverse('smartbusinesslaw_demo:txt_estado_resultados', args=[obj.id])
  #  url_pdf = reverse('smartbusinesslaw_demo:pdf_estado_resultados', args=[obj.id])
    return mark_safe(
        f'<a href="{url_txt}" target="_blank"><span class="material-symbols-outlined">download</span> TXT</a> | '
    #    f'<a href="{url_pdf}" target="_blank"><span class="material-symbols-outlined">picture_as_pdf</span> PDF</a>'
    )
...
def SCVS_CambiosPatrimonio(obj):
    url_txt = reverse('smartbusinesslaw_demo:txt_cambios_patrimonio', args=[obj.id])
   # url_pdf = reverse('smartbusinesslaw_demo:pdf_cambios_patrimonio', args=[obj.id])
    return mark_safe(
        f'<a href="{url_txt}" target="_blank"><span class="material-symbols-outlined">download</span> TXT</a> | '
    #    f'<a href="{url_pdf}" target="_blank"><span class="material-symbols-outlined">picture_as_pdf</span> PDF</a>'
    )
...
def SCVS_FlujoAnexos(obj):
    url_txt = reverse('smartbusinesslaw_demo:txt_flujo_anexos', args=[obj.id])
   # url_pdf = reverse('smartbusinesslaw_demo:pdf_anexos', args=[obj.id])
    return mark_safe(
        f'<a href="{url_txt}" target="_blank"><span class="material-symbols-outlined">download</span> TXT</a> | '
    #    f'<a href="{url_pdf}" target="_blank"><span class="material-symbols-outlined">picture_as_pdf</span> PDF</a>'
    )
...
class SCVSFinancialReportAdmin(ModelAdmin):
    ...
    # ---------------------------
    list_sections = [
        DatosGeneralesComponentDemo,
        BalanceGeneralComponentDemo,
        EstadoResultadosComponentDemo,
        CambiosPatrimonioComponentDemo,
        FlujoEfectivoComponentDemo,
        AnexosSCVSComponentDemo,
    ]
...
@register_component
class ActaDelegadoComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class ActaIncidenteComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
class SPDP_ActaDelegadoAdmin(ModelAdmin):
    list_sections = [
    ActaDelegadoComponentDemo,ActaIncidenteComponentDemo,
    ]
...
@register_component
class ActaJuntaGeneralComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class NominaSociosComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class NominaAdministradoresComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class InformeGerenteComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class SCVSChecklistComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
class SCVS_ActasAsambleaAdmin(ModelAdmin):
    ...
    # ----------------------------------
    list_sections = [
        SCVSChecklistComponentDemo,
        ActaJuntaGeneralComponentDemo,
        NominaSociosComponentDemo,
        NominaAdministradoresComponentDemo,
        InformeGerenteComponentDemo,
    ]
...
@register_component
class ATSComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class BeneficiariosComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class ATS_RetencionesComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class RDEPComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class DividendosComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
    name = "ADI"
...
@register_component
class PartesRelacionadasComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class ConciliacionTributariaComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
class SRI_AnexosTributariosAdmin(ModelAdmin):
    ...
    list_sections = [
        ATSComponentDemo,
        ATS_RetencionesComponentDemo,
        RDEPComponentDemo,
        DividendosComponentDemo,
        PartesRelacionadasComponentDemo,
        ConciliacionTributariaComponentDemo,
        BeneficiariosComponentDemo,  # <-- agregado
    ]
...
@register_component
class IdentificacionComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class IVAComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class RentaComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class RetencionesComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
@register_component
class ICEISDComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
    name = "ICE e ISD"
...
@register_component
class PatenteComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
class SRI_DeclaracionImpuestosAdmin(ModelAdmin):
    ...
    list_sections = [
        IdentificacionComponentDemo,
        IVAComponentDemo,
        RentaComponentDemo,
        RetencionesComponentDemo,
        ICEISDComponentDemo,
        PatenteComponentDemo,
    ]
...
# ================================
@register_component
class ContratoIdentificacionComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
# ================================
@register_component
class EmpleadorComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
    name = "Empleador"
...
# ================================
@register_component
class TrabajadorComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
    name = "Trabajador"
...
# ================================
@register_component
class RemuneracionComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
    name = "Remuneración"
...
# ================================
@register_component
class ClausulasComponentDemo(BaseComponent):
    template_name = "admin/profile_card.html"
...
class ContratoLaboralAdmin(ModelAdmin):
    ...
    # ----------------------------------
    list_sections = [
        ContratoIdentificacionComponentDemo,
        EmpleadorComponentDemo,
        TrabajadorComponentDemo,
        RemuneracionComponentDemo,
        ClausulasComponentDemo,
    ]
